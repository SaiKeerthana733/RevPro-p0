...
public class RemoveFromCartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("Received productId: " + productIdStr); // Debug log
        ...
        if (productIdStr != null) {
            try {
                ...
                // Initialize CartService with userId and available products
                cartService = new CartService(userId, availableProducts); 

                // Remove the item from the cart
                boolean removed = cartService.removeItemFromCart(productId);
                System.out.println("Item removal status: " + removed); // Debug log
            } catch (NumberFormatException e) {
                System.out.println("Error: Invalid number format for productId.");
