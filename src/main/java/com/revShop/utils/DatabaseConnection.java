...
public class DatabaseConnection {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/Project"; // Update with your database name
    private static final String USER = "root"; // Update with your database username
    private static final String PASSWORD = "NikkuPatel"; // Update with your database password
